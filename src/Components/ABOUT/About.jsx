...
import Founder_img from "../../Images/founder.jpeg"


const About = () => {
    return (
<section className =" container-fluid about_containter col-sm-12" id="about">
           
                

            <div className = "  about_nd-carou_row row">
                    ...
                    <div className = "col-sm-6 founder_words">
                        <div>
                                    <i>
                                        ...
                                        Ducimus numquam exercitationem unde pariatur cum earum molestiae magni, 
                                        soluta accusamus dolores temporibus alias 
                                        reprehenderit in amet harum beatae optio omnis fugiat?"


                                        
                                    </i>
                                     <br />
                                    <p className = "founder_name">-Worlanyo Degboe, <br /> Founder, <span className = "meizon"> Meizon World.</span></p>
                        </div>
                    </div>

                    <div className = "col-sm-6">
                            <img src={Founder_img} className = "img-responsive founderimg" alt="" />
                    </div>
